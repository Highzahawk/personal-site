...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center p-24">
      ...
      excited to learn more about Human Computer Interaction and work on this website throughout the quarter. Here is a photo of my friends and I at a Go Karting track. </p>
      <div className="mb-5">
        <Image
          src="/tempsitephoto.jpg" // Replace with the path to your image
          alt="Your Name"
